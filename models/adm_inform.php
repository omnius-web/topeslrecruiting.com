  ...
  <div class="om_form1_div">
    ...
    <div class="om_form1_div_input_row1">
      ...
      <li class="om_form1_dir_input">
        <input type="text" name="wr0" value="" class="om_form1_dir_input_input">
      </li>
    </div>
    <!-- form 1 row -->
  ...
  <div class="om_form1_div">
    ...
    <div class="om_form1_div_input_row1">
      ...
      <li class="om_form1_dir_input om_form1_radio_text">
        <textarea name="wr29" style="width: 100%; height: 100px;"></textarea>
      </li>
    </div>
    <!-- form 1 row -->
...
<!-- 주소 -->
    ...
    <input type="hidden" name="action" value="omnius_adm_in"><?php
    wp_nonce_field( 'omnius_adm_in', 'omnius_adm_in_field' )
    ?>
    <div class="om_form_submit_div">
      <button type="submit" class="om_form_submit" >원어민 강사 구인 입력하기</button>
    </div>
